...
class SalesController extends Controller
{
    ...
    public function storeProfit(Request $request)
    {
        ...
        return redirect()->route('target.index')->with('success', 'Keuntungan hari ini berhasil disimpan!');
    }

    public function storeMenu(Request $request)
    {
        // Simpan menu makanan/minuman yang terjual
        return redirect()->route('target.index')->with('success', 'Data menu terjual berhasil disimpan!');
    }
}
